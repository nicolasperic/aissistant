...
Commerce extends vanilla RequireJS with its own bootstrap sequence:
...
Page Load Sequence (simplified)
  ...
  <script src="requirejs/require.js"
          data-main="mage/requirejs/resolver"> <-- entry point
       |
       v
...
Loads a JS file for the current page/block context. The module's code runs when loaded.
    ...
    <body>
        <referenceContainer name="content">
            <block class="Magento\Framework\View\Element\Template"
                ...
                <!-- Method 1: Add a JS file directly -->
                <arguments>
                    <argument name="script" xsi:type="string">
                        Vendor_Module/js/my-init-script
                    </argument>
                </arguments>
            </block>
        </referenceContainer>

        <!-- Method 2: pageLoad scripts (loaded for entire page) -->
        <referenceBlock name="require.js">
            <arguments>
                <argument name="files" xsi:type="array">
                    <item name="vendor_script" xsi:type="string">
                        Vendor_Module/js/my-page-script
                    </item>
                </argument>
            </arguments>
        </referenceBlock>
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <module name="Vendor_Learning" setup_version="1.0.0"/>
</config>
```
...
'underscore'              // Underscore.js (lodash-compatible)
'ko'                      // KnockoutJS
'mage/translate'          // Commerce i18n ($t function)
'domReady'                // DOM ready plugin
'mage/url'                // URL builder utility
'Magento_Ui/js/lib/core/element/element'  // UI Component base
'uiComponent'             // Shorthand for UI Component
...
- [ ] **Layout XML** — adds JS files via `<referenceBlock>` or `<block>` with script arguments
...
- [ ] `domReady` → DOM ready RequireJS plugin
- [ ] `uiComponent` → base UI Component class
