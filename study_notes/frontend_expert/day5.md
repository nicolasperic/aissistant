...
**Method 2: Query the layout XML dump via URL parameter**

Add `?showTemplateHints=1` to a product URL in development mode.
...
```bash
# Enable layout debug logging
bin/magento config:set dev/debug/template_hints_storefront 1

# Check generated layout files in:
