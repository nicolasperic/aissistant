...
<!-- Note: only 3 options visible; correct answer is app/design/frontend/MyCompany/mytheme/web/images/ -->
...
- [x] `app/code/Orange/Customer/view/frontend/web/templates/customer-info.phtml`
- [ ] `app/code/Orange/Customer/view/frontend/templates/customer-info.phtml`

<!-- Note: only 3 options visible in strips; marked option has checkbox indicator -->
...
<!-- Note: the checked option uses renderTag('script', [], $scriptString, false) -->
...
<!-- Score 0% — correct answer shown in "Correct Response" column: <referenceBlock name="content"> -->
...
<!-- Score 0% — correct response is the data-mage-init div approach (middle option with checkbox) -->
...
- [ ] In an `.../image/preview.js` file, create the following object:
```js
var uploaderConfiguration = Object.assign(
    {},
    config.additional_data.uploaderConfig,
...
- [x] In an `.../image/master.js` file, create the following object:
```js
var uploaderConfiguration = Object.assign(
    {},
    config.additional_data.uploaderConfig,
...
<!-- Score 0% — correct response shown with checkbox on third option -->
