...
Adobe Commerce (2.4.4+) supports **native webhooks** via the `magento/commerce-eventing` module.

```xml
<!-- app/etc/webhooks.xml - Commerce-side webhook config -->
<webhooks>
...
The `magento/commerce-eventing` module enables Commerce to publish events to Adobe I/O Events.

```bash
# Install Commerce Eventing module
composer require magento/commerce-eventing --no-update
composer update
bin/magento module:enable Magento_AdobeCommerceEventing
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        xsi:noNamespaceSchemaLocation="urn:magento:module-commerce-eventing:etc/io_events.xsd">
