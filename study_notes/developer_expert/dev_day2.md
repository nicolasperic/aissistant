...
class BeforeSetNamePlugin
{
     ...
     * @param  string  $name     Original argument
...
+-- metadata/
    +-- global.php                         <-- compiled DI config (array)
    +-- frontend.php
    +-- adminhtml.php
    ...
```
...
class PluginA
{
    ...
    {
        echo "[PluginA before]";
        return [];  // no argument changes, return empty array (single arg method)
    }
...
- [ ] Files land in `generated/code/` and `generated/metadata/`
