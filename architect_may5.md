...
- Consumer processes must be running: `bin/magento queue:consumers:start async.operations.all`
...
- [ ] Multiple plugins on same method: sorted by `sortOrder`; same order → alphabetical by type name
